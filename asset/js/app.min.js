...
let cart=[]
function loadCart(){const savedCart=localStorage.getItem('cartItems');if(savedCart){cart=JSON.parse(savedCart);console.log('Loaded cart from localStorage:',cart)}}
...
cardBody.append(title,pricesDiv,reviewsWrapper);card.append(cardHeader,cardBody);productsWrapper.appendChild(card)})}
